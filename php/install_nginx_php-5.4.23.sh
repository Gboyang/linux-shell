...
make install
cd ..
cp ./php-5.4.23/php.ini-production /server/php/etc/php.ini
#adjust php.ini
sed -i 's#; extension_dir = \"\.\/\"#extension_dir = "/server/php/lib/php/extensions/no-debug-non-zts-20100525/"#'  /server/php/etc/php.ini
