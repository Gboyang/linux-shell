...
make install
cd ..
cp ./php-5.5.7/php.ini-production /server/php/etc/php.ini
#adjust php.ini
sed -i 's#; extension_dir = \"\.\/\"#extension_dir = "/server/php/lib/php/extensions/no-debug-non-zts-20121212/"#'  /server/php/etc/php.ini
